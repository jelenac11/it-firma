...
INSERT INTO services ("type", name, description, location, price, start_date, end_date, user_id, online, status) VALUES ('CNF', 'International Conference on Information Systems', 'Really good conference', 'Novi Sad', 70, 1642103700000, 1642103800000, 14, false, 'NOT_FINISHED');
...
INSERT INTO services ("type", name, description, location, price, start_date, end_date, user_id, online, status) VALUES ('CNF', 'International Conference on Software Engineering', 'Really good conference', 'Vienna', 900, 1644051600000, 1644483600000, 14, false, 'NOT_FINISHED');
