...
INSERT INTO services ("type", name, description, location, price, start_date, end_date, user_id, online, status) VALUES ('CNF', 'International Conference on Information Systems', 'Really good conference', 'Novi Sad', 70, 1652598000000, 1652857200000, 14, false, 'NOT_FINISHED');
INSERT INTO services ("type", name, description, location, price, start_date, end_date, user_id, online, status) VALUES ('CNF', 'International Conference on Machine Learning', 'Really good conference', 'Belgrade', 200, 1641805200000, 1641830400000, 14, true, 'FINISHED');
INSERT INTO services ("type", name, description, location, price, start_date, end_date, user_id, online, status) VALUES ('CNF', 'International Conference on Software Engineering', 'Really good conference', 'Vienna', 900, 1642523400000, 1642525200000, 14, false, 'NOT_FINISHED');
