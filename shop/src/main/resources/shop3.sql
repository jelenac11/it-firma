...
INSERT INTO users ("type", email, first_name, last_name, "password", last_password_reset_date, name, web_site_url, success_url, fail_url, error_url, enabled) VALUES ('ME', 'merchant5@gmail.com', 'Ognjen', 'Dobric', '$2a$12$wNTgmVgZyA4gzAYqJOxEiOJPwCZ3SFFsGEGRbTaqphjitHmawdr.m', 1608560339402, 'WinWin', 'https://localhost:8080/#/', 'https://localhost:8080/#/success', 'https://localhost:8080/#/fail', 'https://localhost:8080/#/error', true);
INSERT INTO users ("type", email, first_name, last_name, "password", last_password_reset_date, name, web_site_url, success_url, fail_url, error_url, enabled) VALUES ('ME', 'merchant6@gmail.com', 'Stefan', 'Markovic', '$2a$12$wNTgmVgZyA4gzAYqJOxEiOJPwCZ3SFFsGEGRbTaqphjitHmawdr.m', 1608560339402, 'Gigatron', 'https://localhost:8080/#/', 'https://localhost:8080/#/success', 'https://localhost:8080/#/fail', 'https://localhost:8080/#/error', true);
