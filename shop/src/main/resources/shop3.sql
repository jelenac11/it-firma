...
INSERT INTO users ("type", email, first_name, last_name, "password", last_password_reset_date, name, web_site_url, success_url, fail_url, error_url) VALUES ('ME', 'merchant5@gmail.com', 'Ognjen', 'Dobric', '$2a$12$wNTgmVgZyA4gzAYqJOxEiOJPwCZ3SFFsGEGRbTaqphjitHmawdr.m', 1608560339402, 'WinWin', 'http://localhost:8080/#/', 'http://localhost:8080/#/success', 'http://localhost:8080/#/fail', 'http://localhost:8080/#/error');
INSERT INTO users ("type", email, first_name, last_name, "password", last_password_reset_date, name, web_site_url, success_url, fail_url, error_url) VALUES ('ME', 'merchant6@gmail.com', 'Stefan', 'Markovic', '$2a$12$wNTgmVgZyA4gzAYqJOxEiOJPwCZ3SFFsGEGRbTaqphjitHmawdr.m', 1608560339402, 'Gigatron', 'http://localhost:8080/#/', 'http://localhost:8080/#/success', 'http://localhost:8080/#/fail', 'http://localhost:8080/#/error');
