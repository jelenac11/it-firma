package com.firma.psp.security;
...
public class TokenUtils {
	...
	public String generateToken(String username, String role) {
		return Jwts.builder().setIssuer(APP_NAME).setSubject(username).setAudience(generateAudience())
				.setIssuedAt(new Date()).setExpiration(generateExpirationDate()).claim("role", role)
	...
	public boolean validateToken(String token, UserDetails userDetails) {
		...
		return (username != null && username.equals(((Merchant) userDetails).getEmail()));
	}
