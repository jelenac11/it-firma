...
public class RestTemplateConfiguration {
	...
	RestTemplate restTemplate() throws KeyStoreException, IOException, NoSuchAlgorithmException,
		...
		keyStore.load(new FileInputStream(new ClassPathResource("paypal-keystore.jks").getFile()),
				keyStorePass.toCharArray());
		KeyStore trustStore = KeyStore.getInstance(KeyStore.getDefaultType());
		trustStore.load(new FileInputStream(new ClassPathResource("paypal-truststore.jks").getFile()),
